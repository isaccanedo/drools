...
import com.isaccanedo.drools.model.Customer;
import com.isaccanedo.drools.model.Customer.CustomerType;
...
public class DiscountExcelIntegrationTest {
    ...
    @Before
    public void setup() {
        Resource resource = ResourceFactory.newClassPathResource("com/isaccanedo/drools/rules/Discount.xls", getClass());
